...
namespace HomeworkCheckerLibTest
{
  public class TestCheckstyle
  {
    ...
    public void Can_process_checkstyle()
    {
      ...
      appExecuterMock.Setup(x => x.Execute("java", Path.Combine("currentFolder", "checkstyle"), "-jar \"checkstyle-10.2-all.jar\" -c google_checks_modified.xml \"somePath\\file.java\""))
